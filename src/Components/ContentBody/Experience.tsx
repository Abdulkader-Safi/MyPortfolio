      ...
      <div className="resume-section-content">
        ...
        <div className="d-flex flex-column flex-md-row justify-content-between mb-5">
          <div className="flex-grow-1">
            ...
            <p>Internship in Verizon as full stack web developer using reactJS in front end and laravel back end development connecting front and back end using APIs</p>
          </div>
